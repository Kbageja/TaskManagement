...
import { createTask, deleteTask, getPeakHours, getProductivityTrends, getTaskAnalytics, getUserAllTasks, getUserTasks, updateTask } from '../controllers/TaskController.js';
const router = express.Router();
router.get("/getUserTasks/:groupId",isAuthenticated,getUserTasks);
router.get("/getUserAllTasks/:userId",isAuthenticated,getUserAllTasks);
